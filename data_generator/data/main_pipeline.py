...
from generate_data.subscription import (
    generate_random_subscription_details,
    generate_subscriptions_data,
)
...
def main():
    ...
    subscriptions_details_data = generate_random_subscription_details(
        transactions_data
    )
